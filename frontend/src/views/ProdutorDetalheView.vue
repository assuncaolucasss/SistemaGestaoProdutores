  ...
  <div class="max-w-3xl mx-auto px-6 py-10">
    ...
    <div v-if="produtor">
      ...
      <div
        ...
        class="flex flex-col items-center justify-center text-gray-400 py-8 gap-2 border border-dashed border-gray-200 rounded-xl"
      >
...
onMounted(async () => {
  try {
    const { data } = await api.get(`/produtores/${produtorId}`)
    produtor.value = data
  } catch (err) {
